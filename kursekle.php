...
if ($_POST){
	...
	$kontrol = mysql_query("insert into salla (kursadi, kurssuresi, kurstarihi, kursgunleri, kursyeri, kursaciklama) values ('$kursadi','$kurssuresi','$kurstarihi','$kursgunleri','$kursyeri','$kursaciklama')");
	if($kontrol){
		echo "Kayıt eklendi";
	}else{
